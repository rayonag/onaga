...
const Type: FC<TypeProps> = ({ type, setType, incomeExpense }) => {
    ...
    const buttonStyle = (val: string) => `${touched == val ? "bg-gray-300 " : val == type ? "bg-cyan-600 " : "bg-gray-400 "} m-3 w-40 h-40 text-white rounded-lg justify-center text-4xl shadow-md transition-colors`;
